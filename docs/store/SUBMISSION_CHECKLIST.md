...
> **現在の状態（2026年8月31日）:** 初回のx64版・ARM64版は認定に合格し、Storeで公開済みです。
> ワークスペース、列操作、自動翻訳ボタン、設定画面、掲載情報を改善したv2.5.0を準備しています。
> 初回合格を次回更新の合格保証として扱いません。
...
- [ ] v2.5.0用の個人情報が写っていないスクリーンショットを4枚以上保存した
- [x] v2.5.0用の日本語・英語の説明、機能、「新機能」、検索語案を保存した
- [x] カテゴリと年齢区分
- [x] プライバシーポリシーURL
- [x] サポートURL
...
- [ ] v2.5.0のソース、manifest、掲載版、パッケージ版が一致している
